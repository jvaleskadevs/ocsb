        ...
        <div className="flex justify-between items-center p-2.5 px-4">
          ...
          <div className="gap-1 hidden md:flex items-center">
            <Link href={siteConfig.links.farcasterChannel} target="_blank">
              <div className="flex flex-row gap-2 p-2 border dark:border-zinc-800/50 border-zinc-800/20 rounded-full hover:bg-accent">
                Onchain Blocks <SiFarcaster size={20} className='dark:text-zinc-100 dark:hover:text-zinc-300 text-zinc-900/95' />
              </div>
            </Link>
            <Link href={siteConfig.links.farcaster} target="_blank">
              <div className="flex flex-row gap-2 p-2 border dark:border-zinc-800/50 border-zinc-800/20 rounded-full hover:bg-accent">
                J. Valeska <SiFarcaster size={20} className='dark:text-zinc-100 dark:hover:text-zinc-300 text-zinc-900/95' />
              </div>
            </Link>
            {/*
